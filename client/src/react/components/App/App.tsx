...
import {InputInterface} from "../../context/AppContext";
import AppContext from '../../context/AppContext';
import Error from '@backend/Error';
import Welcome, {ErrorData, WeatherData} from "../data/Data";
import InputType from "../../../types/InputType";
import './App.scss';
import {DEFAULT_CITY_STATE, DEFAULT_COORDINATES, DEFAULT_POSTAL_CODE} from "../../../util/Constants";
...
function App() {
  ...
  let value = { input, setInput, getDefaultInput, inputType, setInputType, data, setData }
  return (
